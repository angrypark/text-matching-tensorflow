...
class BestModel8(Model):
    ...
    def build_model(self):
        ...
        with tf.variable_scope("sampling"):
            ...
            negative_queries_indices = tf.to_int32(negative_queries_indices)
            negative_replies_indices = tf.to_int32(negative_replies_indices)
