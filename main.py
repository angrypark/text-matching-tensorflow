...
args.add_argument("--pretrained_embed_dir", type=str, default="/media/scatter/scatterdisk/reply_matching_model/pretrained_embedding/fasttext.sent_piece_100K.256D")
...
args.add_argument("--sent_piece_model", type=str, default="/media/scatter/scatterdisk/reply_matching_model/tokenizer/sent_piece.100K.model")
args.add_argument("--soynlp_scores", type=str, default="/media/scatter/scatterdisk/reply_matching_model/tokenizer/soynlp_scores.sol.100M.txt")
...
args.add_argument("--vocab_list", type=str, default="/media/scatter/scatterdisk/reply_matching_model/pretrained_embedding/vocab_list.sent_piece_100K.txt")
